...
def trade_logic(df, trade_log, position):
    ...
    # Averaging Down Logic
        ...
        trade_log.append({"timestamp": datetime.now(), "action": "AVERAGE_DOWN", "price": current_price, "contracts": additional_contracts})
    ...
    # Exit Logic
        ...
        trade_log.append({"timestamp": datetime.now(), "action": "SELL_CALL", "price": current_price, "contracts": position["contracts"], "exit_value": exit_value})
